 ...
 * @版本：V1.0
 */
public class HBaseImpl extends Storage<FileInfo> {
	private static final Logger logger = LoggerFactory
			.getLogger(HBaseImpl.class);
	private static Constants constants = Constants.getInstance();
	private HConnection connection;
	private String tableName;

	public HBaseImpl(String tableName) {
				...
				if (property != null) {
					if (field.getName().equals("id")) {
						...
						File file = new File(property.toString());
							p.add("data".getBytes(), "zip".getBytes(),
...
//		a.setXmlContent("aaaaaaaaaaaaaaaaaaaaaaaa");
		...
		HBaseImpl storageHBaseImpl = new HBaseImpl("inspection");
