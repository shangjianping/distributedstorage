...
public abstract class ImageUtils {
    ...
    private static int iconWidth=constants.getICON_WIDTH();
    private static int iconHeight=constants.getICON_HEIGHT();
     ...
     * @throws IOException
     */
    public static String resize(String savePath, File targetFile) throws ImageFormatException, IOException {
        image = ImageIO.read(targetFile);
        return resize(iconWidth,iconHeight, savePath, image);
    }
...
//    	for(int i=0;i<20;i++){
        System.out.println(ImageUtils.resize("E:/交互式图像/image/绿/86574MB01201212280081（绕管器）/86574MB01201212280081_icon.jpg", new File("E:/交互式图像/image/绿/86574MB01201212280081（绕管器）/86574MB01201212280081.jpg")));
//    	}
//    	System.out.println(new SimpleDateFormat("yyyy/MM/dd  HH:mm:ss:SSS").format(new Date()));
        Image a = ImageIO.read(new File("E:/交互式图像/image/绿/86574MB01201212280081（绕管器）/86574MB01201212280081.jpg"));
        int x= a.getWidth(null);
        int y = a.getHeight(null);
        Image b = ImageIO.read(new File("E:/交互式图像/image/绿/86574MB01201212280081（绕管器）/86574MB01201212280081_icon.jpg"));
        ImageUtils.resize(x, y, "E:/交互式图像/image/绿/86574MB01201212280081（绕管器）/bb.jpg", b);
    }
}
